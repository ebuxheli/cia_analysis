---
title: "Replication of 'Partners in Crime: An Empirical Evaluation of the CIA Rendition, Detention, and Interrogation Program' by Schmidt and Sikkink <br/> <br/> ⚕️"
...
include_graphics("present/fig1.png")
```
---
# What it shows...
- Shading highlights the 2001–2005 period where other countries began to adopt RDI
<br/><br/> 
- CIRI data presents no change in human rights practices during the study period
<br/><br/> 
...
```{r echo = FALSE, warning = FALSE}
include_graphics("present/countries.png")
```
...
<br/><br/>
- Presents the variety of countries that participated
...
```{r echo = FALSE, warning = FALSE}
include_graphics("present/fig2.png")
```
...
```{r echo = FALSE, warning = FALSE}
include_graphics("present/table2.png")
```
...
```{r echo = FALSE, warning = FALSE}
include_graphics("present/table3.png")
```
